...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
    ...
    <div>
        ...
        <div class="form-group col-lg-12 form-row radio">
            <input type="radio" class="woocommerce-Input woocommerce-Input--text input-text" name="services" id="tutoring" <?php if ($user->services == "tutoring") { ?> checked="" <?php } ?> value="tutoring"   />
            <label for="reg_tutoring"><?php _e('Tutoring', 'woocommerce'); ?> <span class="required"></span></label>
        </div>   
        <div class="form-group col-lg-12 form-row radio">
            <input type="radio" class="woocommerce-Input woocommerce-Input--text input-text" name="services" id="reg_fname" <?php if ($user->services == "admission") { ?> checked="" <?php } ?> value="admission" />
            <label for="reg_admission"><?php _e('Admission', 'woocommerce'); ?> <span class="required"></span></label>
        </div>   
    </div>
    <div class="clear"></div>
