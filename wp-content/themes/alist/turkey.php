<div class="main-body">
    <div class="main-content">
        ...
        <div class="uk-banner" style="background-image: url(<?php echo $feat_image; ?>)">
            ...
            <a href="/turkey/get-started" class="default-btn">Start My Journey</a>
        </div><!--uk-banner-->
        ...
        <div class="parents-partners">
            ...
            $args = array(
                ...
                'posts_per_page' => 2,
                'caller_get_posts' => 1,
                'category_name' => 'turkey_home_links'
            );
            $my_query = null;
        ...
        <div class="exceptional-sat">
            ...
            <div class="utility__mar-bumb-top-bottom">
                <a href="/turkey/get-started" class="default-btn">Get Started</a>
            </div>
        </div><!--exceptional-sat-->
        <div class="clearfix"></div><!--clearfix-->
