...
<div class="main-body">
    <div class="main-content">
            ...
            <ul class="container partner-org__list-outer-wrap">
                <?php
                    ...
                    $args = array(
                        ...
                        'caller_get_posts' => 1,
                        'orderby' => 'post_title',
                        'category_name' => 'Partner Organization'
                    );
                    $my_query = null;
        ...
        <div class="container-outer-wrap">
            <div class="container">
                <h3><b>Professionals:</b></h3>
            <!-- start Partner Organization Professionals loop -->
            <ul class="container partner-org__list-outer-wrap">
                <?php
                    $type = 'page';
                    $args = array(
                        ...
                        'caller_get_posts' => 1,
                        'orderby' => 'post_title',
                        'category_name' => 'Partner Organization Professionals'
                    );
                    $my_query = null;
                    $my_query = new WP_Query($args);
                    if ($my_query->have_posts()) {
