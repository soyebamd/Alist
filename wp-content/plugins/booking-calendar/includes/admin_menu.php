...
class wpdevart_bc_admin_menu{
	...
	public function calendar_requeried_scripts(){
		...
		wp_enqueue_style(WPDEVART_PLUGIN_PREFIX.'-admin-style', WPDEVART_URL.'css/admin_style.css');
		wp_enqueue_style(WPDEVART_PLUGIN_PREFIX.'calendar-style', WPDEVART_URL.'css/booking.css');
		wp_register_script( WPDEVART_PLUGIN_PREFIX.'-admin-calendar', WPDEVART_URL.'js/admin_calendar.js', array("jquery") );
	...
	public function featured_plugins(){
		$plugins_array=array(
			...
			'countdown'=>array(
						...
						'description'	=>	'WordPress Countdown plugin is an nice tool for creating and inserting countdown timers into your posts/pages and widgets.'
						),
            'facebook-comments'=>array(
						...
						'description'	=>	'Our Facebook comments plugin will help you to display Facebook Comments on your website. You can display Facebook Comments on your pages/posts.'
						),						
			'facebook'=>array(
